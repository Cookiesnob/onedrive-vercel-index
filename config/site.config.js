...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'owner@myloves.onmicrosoft.com',
  ...
  email: 'mailto:cookiesnob@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/cookiesnob/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/cookiesnob',
    },
  ],
